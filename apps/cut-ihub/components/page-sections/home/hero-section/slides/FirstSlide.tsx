        ...
        <div className="xl:max-w-3xl max-w-2xl ">
          <div className="  w-full my-auto inline-block text-white z-10 flex-col ">
            ...
            <p className="text-gray-200 pt-4">
              Supporting innovators and entrepreneurs in transforming world
              changing ideas into technologically feasible entities/solutions of
              economic growth through production of goods and Service
            </p>
